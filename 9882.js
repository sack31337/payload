...
"undefined" == typeof CE2 && (CE2 = {}), CE2.userDataToJs = function(t) {
...
}, CE_USER_DATA_URL = "https://script.crazyegg.com/pages/data-scripts/0106/9881.json", CE2.debugEnabled = function() {
    ...
    for (var e; e = CE2.LOADED_SCRIPTS_CALLBACKS[t].pop();) e()
}, CE2.loadScript = function(t, e) {
    if (CE2.LOADED_SCRIPTS || (CE2.LOADED_SCRIPTS = []), CE2.INCLUDED_SCRIPTS || (CE2.INCLUDED_SCRIPTS = []), CE2.LOADED_SCRIPTS_CALLBACKS || (CE2.LOADED_SCRIPTS_CALLBACKS = {}), CE2.LOADED_SCRIPTS_CALLBACKS[t] || (CE2.LOADED_SCRIPTS_CALLBACKS[t] = []), e && CE2.LOADED_SCRIPTS_CALLBACKS[t].push(e), -1 < CE2.LOADED_SCRIPTS.indexOf(t)) return CE2.runLoadedScriptCallbacks(t);
    ...
    if (window.performance && performance.getEntriesByType) {
        ...
        if (t && t[0]) return "back_forward" === t[0].type ? parseInt(+new Date / 3e5, 10) : 1
    }
    ...
    if ("undefined" == typeof window) return CE2.s[t];
    var e = "ce_proto_iframe",
